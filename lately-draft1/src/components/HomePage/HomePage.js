      ...
      <div className='main1'>
        ...
        <div className='main2'>
          ...
          <div className='big_daddy'>
            ...
            <div className='review_header'><span href='/artists'>ARTISTS</span></div>
          </div>

          {/* videos */}
          <div className='homepage_videos_parent'>
            <div className='video_header'><span href='/videos'>VIDEOS</span></div>
          ...
          <div className='homepage_playlists_main'>
            <div className='homepage_move_playlists'>
              <div className={this.state.playlistModalVisible ? 'homepage_hide_dates' : 'homepage_playlists_header'}>PLAYLISTS</div>
